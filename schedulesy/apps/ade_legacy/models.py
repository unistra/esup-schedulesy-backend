...
class Edtperso(models.Model):
    ...
    creation_date = models.DateTimeField(db_column='date_creation', blank=True, null=True)
    customization_date = models.DateTimeField(db_column='date_personnalisation', blank=True, null=True)
